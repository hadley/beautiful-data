...
Figure~\ref{fig:census} shows three scatterplots illustrating interesting relationships.  The most affected cities have more babies and children, bigger households, fewer bachelors degrees, and longer commutes.  Most significantly these cities also have lower incomes, which is probably the factor that drives all of the other relationships.  The housing crisis has been relatively more damaging to the house prices of people who live in poorer areas.
...
\begin{figure}[htbp]
  \centering
    \includegraphics[width=0.5\linewidth]{sf-map}%
    \includegraphics[width=0.5\linewidth]{sf-geo}
